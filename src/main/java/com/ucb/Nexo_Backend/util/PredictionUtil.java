...
/*
    public static List<Prediction> predictionCGRAY(List<CountryCases> listcases,Integer cant,Integer filter){
    ...
    public static List<Prediction> predictionDGRAY(List<DepartmentCases> listcases, Integer cant, Integer filter){
    ...
    public static List<Prediction> predictionMGRAY(List<MunicipalityCases> listcases, Integer cant, Integer filter){
